...
const UserSignin = () => {
  ...
  <form onSubmit={handleSubmit} className="w-[400px] p-8 mx-auto rounded-2xl border-2 border-white shadow-2xl bg-white/10 backdrop-blur-md relative">
    ...
    <input id="name" value={formData.username} onChange={handleChange} name="username" type="text" className="w-full mb-6 p-3 rounded-md bg-gray-200/90 focus:outline-none" />

    <label className="block text-xl font-bold text-white mb-2" htmlFor="password">PASSWORD:</label>
    <input id="password" value={formData.password} onChange={handleChange} name="password" type="password" className="w-full mb-6 p-3 rounded-md bg-gray-200/90 focus:outline-none" />
